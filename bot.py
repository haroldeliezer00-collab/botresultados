...
def test_pollas():
    enviar_aviso_pollas()
    return "¡Prueba ejecutada! Se envió el aviso de pollas al canal."
...
def enviar_aviso_pollas():
    mensaje = (
        ...
        "Ya se subieron o ya se actualizó el canal con las pollas de este sorteo, puedes verlo aquí 👇🏻\n"
        "https://t.me/pollasydupletas\n\n"
        "¡Mucho éxito en tus jugadas! 🍀"
    )
    enviar_telegram(mensaje, disable_web_preview=False)
    print("📢 Aviso de pollas enviado.")
...
def loop_bot():
    ...
    # Aviso de pollas al minuto 10 de cada hora
